...
\item Connect the fitting to tool to the subsequently selected canvas.
\item Re-Draw histogram and saved fits. Useful to reset problematic fit markers.
...
\item Place fit constraints on parameters suitable for $\gamma$-ray spectra.
